...
const submitRegister = document.querySelector('#register');
const submitLogin = document.querySelector('#login');
const submitContact = document.querySelector('#contact');



// Check first name if contains letters in a-z in lowercase
function isValidFirstName(firstName) {
  const regex = /^[a-zA-Z]$/;
  if (regex.test(firstName.value)) {
    setSuccessFor(firstName);
  } else {
    setErrorFor(firstName, "Enter a last name");
  }
}


// Check last name if contains letters in a-z in lowercase
function isValidLastName(lastName) {
  const regex = /^[a-zA-Z]$/;
  if (regex.test(lastName.value)) {
    setSuccessFor(lastName);
  } else {
    setErrorFor(lastName, "Enter a first name");
  }
}
